(() => {
  ...
  const scripts=['/experience-countdown.js','/experience-home.js','/experience-motion.js','/brand-shell-fix.js','/structure.js','/player-experience-fix.js','/player-experience-guard.js'];
