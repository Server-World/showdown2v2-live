(() => {
  const styles=['/experience.css','/experience-home.css','/experience-fixes.css','/brand-shell-fix.css','/structure.css'];
  ...
  const scripts=['/experience-countdown.js','/experience-home.js','/experience-motion.js','/brand-shell-fix.js','/structure.js'];
